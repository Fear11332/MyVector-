...
{
public:
	MyVector(size_t size = 0, ResizeStrategy flag = ResizeStrategy::Multiplicative, float coef = 1.5f);
	MyVector(size_t size, ValueType value, ResizeStrategy flag = ResizeStrategy::Multiplicative, float coef = 1.5f);
